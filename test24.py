...
# ทั้งนี้โปรแกรมจะหยุดทำงานก็ต่อเมมื่อป้อนชื่อพนักงาน เป็น SAU ก็จะหยุดทำงาน

print("----------------------")
print('โปรเเกรมคำนวณอายุพนักงาน')
print("----------------------")

while True :
  emp_name = input("ป้อนชื่อพนักงาน")
  if emp_name.lower.upper() == 'sau' :
    break
  emp_year = int(input('ป้อนปีเกิด'))
