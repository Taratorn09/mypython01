...
# ซึ่งมี 4 ประเภท คือ food(F/f), woman(W/w), man(M/m), kitchen(K/k) 
...
if pro_type == 'f' or pro_type == 'f' :
  ...
  print('คุณป้อนประเภทผิด !!! ป้อนใหม่อีกครั้ง')
print('--------------------')
